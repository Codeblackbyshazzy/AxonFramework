...
/**
 * Annotation marking a method as an event-specific interceptor handler on an
 ...
 *       proceeded by calling {@code chain.proceed(event, ctx)}; it can also short-circuit by returning without
 *       calling proceed.</li>
 * </ul>
 * <p>
