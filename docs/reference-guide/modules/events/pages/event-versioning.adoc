...
Furthermore, the stream of events starts from the xref:event-processors/streaming.adoc#tracking_tokens[tracking token's] position for a xref:event-processors/streaming.adoc[streaming event processor].
